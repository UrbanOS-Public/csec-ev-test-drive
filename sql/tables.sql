...
values
  ...
  (1000127, 'Select the name of the person who was your right seat driver', 1000511, 'MC', 0),
...
values
  ...
  (1000665, 1000127, 'Zakaria Farah', FALSE, 0, null),
  (1000666, 1000127, 'Cassidy Jenney', FALSE, 1, null),

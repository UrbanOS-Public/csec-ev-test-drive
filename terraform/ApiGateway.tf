...
module "api_post_scheduleAdhocDrive" {
  source = "./modules/api/create_gateway_method_for_lambda"
  parent_id = "${aws_api_gateway_rest_api.SmartExperienceApi.root_resource_id}"
  rest_api_id = "${aws_api_gateway_rest_api.SmartExperienceApi.id}"
  path = "adhocDrive"
  function_invoke_arn = "${module.ApiScheduleAdhocDriveFunction.invoke_arn}"
  function_arn = "${module.ApiScheduleAdhocDriveFunction.arn}"
  api_key_required = "true"
  account_number = "${var.account_number}"
  method = "POST"
  region = "${var.region}"
...
module "api_post_deleteException" {
  source = "./modules/api/create_gateway_method_for_lambda"
  parent_id = "${aws_api_gateway_rest_api.SmartExperienceApi.root_resource_id}"
  rest_api_id = "${aws_api_gateway_rest_api.SmartExperienceApi.id}"
  path = "deleteException"
  function_invoke_arn = "${module.ApiDeleteExceptionFunction.invoke_arn}"
  function_arn = "${module.ApiDeleteExceptionFunction.arn}"
  api_key_required = "true"
  account_number = "${var.account_number}"
  method = "POST"
  region = "${var.region}"
...
module "api_edit_drive" {
  ...
  rest_api_id = "${aws_api_gateway_rest_api.SmartExperienceApi.id}"
  path = "editDrive"
  function_invoke_arn = "${module.ApiEditDriveFunction.invoke_arn}"
  function_arn = "${module.ApiEditDriveFunction.arn}"
  api_key_required = "true"
  account_number = "${var.account_number}"
  method = "POST"
  region = "${var.region}"
